...
<body>
<div id="loading" style="display:none;position: absolute;top: 0px;z-index:10000;height: 140%;width: 100%;background: grey;opacity: 0.5" >
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 0%">
                ...
                <%--</div>--%>
                <div id="richContent" class="content"></div>
            </div>
        </div>
...
<script>
    ...
    function addImg(url,path) {
        var editor = document.getElementsByClassName('w-e-text')[0];
